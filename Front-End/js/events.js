async function getEvents() {
  ...
  let { data } = await axios.get(`${url}allEvents`);
  // console.log(data);

  let events = data.map((item) =>`
    <img data-aos="fade-down" data-aos-duration="500" style="scale: 1.2;margin-top: 80px;" src="${url}${(item.clientID.logo.replace("uploads\\", ""))}" alt="" class="cscale2"></img>

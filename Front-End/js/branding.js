...
async function getbranding() {
  ...
  <div class="container">
    ...
    document.getElementById("data").innerHTML = clients;
	...
	let projects = data.map(item=>
		  ...
		  <div style="display: flex;place-content: center;" class="wow fadeInLeft">
			<div class="row">
			  <div class="col-md-12" style="display: flex;place-content: center;">
				<img src="images/branding/api/API-01.webp" alt="" style="width: 90%;">
			  </div>
			</div>
		  </div>
		</div>
		...
		<div id="div${item.clientName}2" class="dnone">
		  ...
		  <div style="display: flex;place-content: center;" class="wow fadeInLeft">
			<div class="row">
			  <div class="col-md-12" style="display: flex;place-content: center;">
				<img src="images/profile/api/API Profile For KHP-01.webp" alt="" style="width: 90%;">
			  </div>
			</div>
		  </div>
		</div>
		...
		document.getElementById("clientproject").innerHTML = projects;
